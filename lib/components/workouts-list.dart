...
class _WorkoutsListState extends State<WorkoutsList> {
  ...
  Widget build(BuildContext context) {
    ...
    List<DropdownMenuItem<String>> levelMenuItems() {
      List<DropdownMenuItem<String>> dropdownMenuItem = [];
      List<String> list = ['Any Level', 'Beginner', 'Intermediate', 'Advanced'];
      list.forEach((String value) {
        dropdownMenuItem.add(new DropdownMenuItem<String>(
          value: value,
